/***************
FileName: main.java
Assignment 4 - Motion Parallax
Due Date: 03/25/2019 Monday
Names: Pierce Fleming, Michael Newell
In this programming assignment, you will be building a program that displays a landscape in a
graphics function and allows the user to control the perspective of the landscape by moving the
mouse. The perspective seems to change due to an effect called motion parallax, which you should
